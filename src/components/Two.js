...
const Two = () => {
  ...
  return (
  <div className="bg-gradient-to-br from-black via-gray-900 to-slate-900 w-full py-10 sm:py-16 relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="flex flex-col lg:flex-row shadow-2xl rounded-2xl overflow-hidden bg-black/40 backdrop-blur-md border border-gray-700/50">
          ...
          <div className="lg:w-1/2 w-full relative">
            <img
              ...
              className="w-full h-full object-cover min-h-[220px] sm:min-h-[320px] lg:min-h-[400px]"
              loading="lazy"
            />
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
              <a
                href="/kundli"
        className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-yellow-500 to-amber-600 hover:from-yellow-600 hover:to-amber-700 text-black font-bold rounded-lg transition-all duration-300 transform hover:scale-105 text-center"
              >
