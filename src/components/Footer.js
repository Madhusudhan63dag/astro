...
//             <a href="/" className="font-bold text-2xl bg-gradient-to-r from-indigo-500 via-fuchsia-400 to-yellow-300 bg-clip-text text-transparent tracking-wide mb-1">Sri Astro Veda</a>
//             <div className="text-slate-400 text-sm text-center lg:text-left mb-3">Astrology & Vastu. Modern, Personal, Trusted.</div>
...
//             {/* Main Navigation */}
//             <div>
//               <h4 className="text-slate-400 uppercase text-xs font-bold mb-3 tracking-wider">Navigation</h4>
//               <ul className="space-y-2 text-sm">
//                 <li><a href="/" className="hover:text-yellow-300 transition">Home</a></li>
//                 <li><a href="/about" className="hover:text-yellow-300 transition">About</a></li>
//                 <li><a href="/contact" className="hover:text-yellow-300 transition">Contact</a></li>
//                 <li><a href="/form" className="hover:text-yellow-300 transition">Get Reading</a></li>
//               </ul>
//             </div>
...
//                 <span className="mr-1">✦</span> Core Services
//               </h4>
//               <ul className="space-y-2 text-sm">
//                 <li><a href="/birth-chart" className="hover:text-yellow-300 transition">Birth Chart</a></li>
//                 <li><a href="/match-horoscope" className="hover:text-yellow-300 transition">Match Horoscope</a></li>
//                 <li><a href="/ascendant" className="hover:text-yellow-300 transition">Ascendant</a></li>
//                 <li><a href="/dasha-analysis" className="hover:text-yellow-300 transition">Dasha Analysis</a></li>
//                 <li><a href="/nakshatra" className="hover:text-yellow-300 transition">Nakshatra</a></li>
//                 <li><a href="/numerology" className="hover:text-yellow-300 transition">Numerology</a></li>
//               </ul>
//             </div>
...
//             <div>
//               <h4 className="text-slate-400 uppercase text-xs font-bold mb-3 tracking-wider flex items-center">
//                 <span className="mr-1">🔮</span> Predictions
//               </h4>
//               <ul className="space-y-2 text-sm">
//                 <li><a href="/life-predictions" className="hover:text-yellow-300 transition">Life Predictions</a></li>
//                 <li><a href="/2025-predictions" className="hover:text-yellow-300 transition">2025 Report</a></li>
//                 <li><a href="/daily-horoscope" className="hover:text-yellow-300 transition">Daily Horoscope</a></li>
//                 <li><a href="/love-report" className="hover:text-yellow-300 transition">Love Report</a></li>
//                 <li><a href="/career-report" className="hover:text-yellow-300 transition">Career Report</a></li>
//                 <li><a href="/health-report" className="hover:text-yellow-300 transition">Health Report</a></li>
//               </ul>
//             </div>
...
//             <div>
//               <h4 className="text-slate-400 uppercase text-xs font-bold mb-3 tracking-wider flex items-center">
//                 <span className="mr-1">🕉️</span> Remedies
//               </h4>
//               <ul className="space-y-2 text-sm">
//                 <li><a href="/lal-kitab" className="hover:text-yellow-300 transition">Lal Kitab</a></li>
//                 <li><a href="/mangal-dosha" className="hover:text-yellow-300 transition">Mangal Dosha</a></li>
//                 <li><a href="/kalsarp-dosh" className="hover:text-yellow-300 transition">Kalsarp Dosh</a></li>
//                 <li><a href="/sade-sati" className="hover:text-yellow-300 transition">Sade Sati</a></li>
//                 <li><a href="/ask-question" className="hover:text-yellow-300 transition">Ask Question</a></li>
//                 <li><a href="/gemstones" className="hover:text-yellow-300 transition">Gemstones</a></li>
//               </ul>
//             </div>
//           </div>
...
//             <h4 className="text-slate-400 uppercase text-xs font-bold mb-3 tracking-wider">Support</h4>
//             <ul className="space-y-2 text-sm">
//               <li>
...
//           <div>
//             &copy; {new Date().getFullYear()} Sri Astro Veda. All rights reserved.
//           </div>
//           <div className="flex items-center gap-4">
//             <span>Made with <span className="text-pink-400">♥</span> in India.</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 flex-1">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/mangal-dosha" className="hover:text-yellow-300 transition">{t('mangal_dosha_footer')}</a></li>
                <li><a href="/kalsarp-dosh" className="hover:text-yellow-300 transition">{t('kalsarp_dosh_footer')}</a></li>
