...
const Hero = () => {
  ...
  return (
    <div>
      <section className="relative w-full min-h-screen max-h-screen flex items-center justify-center lg:justify-start px-4 sm:px-6 lg:px-9 overflow-hidden">
        ...
        {/* Content - Prevent overflow with scrollable container */}
        <div className="relative z-10 text-center lg:text-left w-full h-full flex flex-col justify-center py-6 sm:py-8 lg:py-12 overflow-y-auto">
          
          {/* Main Content */}
          <div className="flex-shrink-0 my-auto">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight mb-4 sm:mb-6 lg:mb-8 text-white w-full lg:w-1/2">
              {t('unlock_cosmic')}
              <br />
              <span className="bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-500 bg-clip-text text-transparent">
                {t('personalized_predictions')}
            ...
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl w-full lg:w-1/2 font-medium text-gray-300 mb-6 sm:mb-8 lg:mb-10 leading-relaxed max-w-3xl mx-auto lg:mx-0">
              {t('hero_description')}
            </p>
            
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center lg:justify-start mb-6 sm:mb-8 lg:mb-10">
              <a
                href="/kundli"
            ...
            {/* Features grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-5 max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto lg:mx-0">
              {features.map((feature, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 sm:gap-3 text-gray-300 text-xs sm:text-sm lg:text-base font-medium bg-black/40 backdrop-blur-sm rounded-lg px-3 sm:px-4 py-2 sm:py-3 border border-gray-700/50"
                >
