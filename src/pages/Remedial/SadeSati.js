...
const SadeSati = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern - SadeSati symbols */}
      ...
      <div className="relative z-10 py-8 sm:py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            {t('discover_your')} <span className="text-purple-400">{t('sadesati')}</span>
            <br />
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-start">
              ...
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('exact_time_critical_for_sadesati')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('location_essential_for_sadesati')}
                    </p>
                  </div>
                  ...
                  <div>
                      ...
                      <div className="text-center">
                        ...
                        <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            ...
                            <span>{t('sadesati_phase_identification')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('saturn_effects_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('remedies_and_solutions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('timeline_predictions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('life_guidance_during_sadesati')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                    ...
                    <p className="text-gray-400 text-xs sm:text-sm mt-3 text-center">
                      {t('comprehensive_sadesati_analysis_note')}
                    </p>
                  </div>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('complete_sadesati_timeline')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('saturn_influence_analysis')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('life_guidance_insights')}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              {showThankYou ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <p className="text-gray-300 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                        {t('sadesati_analysis_processing')}
                      </p>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('detailed_sadesati_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('saturn_phase_analysis')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('remedial_measures_guidance')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('life_predictions_timeline')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('spiritual_guidance_saturn')}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <>
                  {/* Sample SadeSati Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">🪐</span>
                      {t('sample_sadesati_analysis')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-6 sm:p-8 border border-purple-500/30">
                        <div className="text-center">
                          ...
                          <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('sadesati_phase')}</h4>
                          <p className="text-gray-300 text-xs sm:text-sm">{t('sample_sadesati_description')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-3 sm:mt-4 text-center text-sm sm:text-base">
                      {t('sample_sadesati_preview')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs sm:text-sm">{t('rising_phase')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">🌞</div>
                        <div className="text-gray-300 text-xs sm:text-sm">{t('peak_phase')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">🌅</div>
                        <div className="text-gray-300 text-xs sm:text-sm">{t('setting_phase')}</div>
                      </div>
                    </div>
                  </div>
                </>
                ...
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                    <span className="text-purple-400 mr-3">🪐</span>
                    {t('your_sadesati_analysis_status')}
                  </h3>
                  <div className="text-center">
