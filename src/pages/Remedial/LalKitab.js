...
import lal_kitabImage from '../../assets/2.webp';
...
const LalKitab = () => {
  ...
  const BC_PRICE_NUMBER = getRawPrice(PRICE_KEYS.lalKitab);
  const BC_PRICE_FORMATTED = getFormattedPrice(PRICE_KEYS.lalKitab);
    ...
    try {
      ...
      if (verifyResult.success) {
        ...
        const astroEmailData = {
          ...
          language: formData.language,
          additionalInfo: 'Complete Lal Kitab (Kundli) Analysis Request',
          paymentDetails: {
            status: 'paid',
  ...
  const initializePayment = async (orderData) => {
    ...
    const options = {
      ...
      name: 'SriAstroVeda',
      description: 'Lal Kitab Analysis - Complete Kundli Report',
      image: '/logo192.png',
    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceFeatures={[
            t('detailed_lal_kitab_pdf') || "Detailed Lal Kitab (PDF)",
          ...
          <div className="relative z-10 py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
                {t('craft_your_destiny')} <span className="text-purple-400">{t('lal_kitab_title')}</span>
                          ...
                          <div className="text-center">
                            ...
                            <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                              <li className="flex items-center gap-2">
                                ...
                                <span>{t('detailed_lal_kitab_report')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
                              ...
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
                                <span>{t('lal_kitab_remedies')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
