          ...
          try {
            ...
            if (verifyResult.success) {
              ...
              const astroEmailData = {
                ...
                language: formData.language,
                additionalInfo: 'Complete LalKitab (Kundli) Analysis Request',
                paymentDetails: {
                  status: 'paid',
                  amount: 599,
    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceAmount="₹599"
          serviceFeatures={[
            t('detailed_lal_kitab_pdf') || "Detailed LalKitab (PDF)",
                          ...
                          <div className="text-center">
                            ...
                            <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                              <li className="flex items-center gap-2">
                                ...
                                <span>{t('detailed_lal_kitab')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
