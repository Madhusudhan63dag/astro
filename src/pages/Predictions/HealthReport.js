    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceAmount="₹599"
          serviceFeatures={[
            t('detailed_health_report_pdf') || "Detailed Birth Chart (PDF)",
                    ...
                    <form onSubmit={handleGenerateAnalysis} className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        ...
                        <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                          <div className="text-center">
                            <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('complete_health_report_analysis')}</h4>
