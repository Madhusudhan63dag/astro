...
const CareerReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern - CareerReport symbols */}
      ...
      <div className="relative z-10 py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">
            {t('discover_your')} <span className="text-purple-400">{t('career_path')}</span>
            <br />
            <span className="bg-gradient-to-r from-purple-400 via-pink-300 to-violet-500 bg-clip-text text-transparent">
              {t('professional_destiny_analysis')}
            </span>
          </h1>
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            {t('career_report_description')}
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                  ...
                  {t('enter_details_for_career_analysis')}
                </h2>
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-sm mt-2">
                      {t('exact_time_critical_for_career')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-sm mt-2">
                      {t('location_essential_for_career')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-6">
                      <div className="text-center">
                        <h4 className="text-xl font-semibold text-white mb-2">{t('complete_career_analysis')}</h4>
                        <div className="text-4xl font-bold text-purple-400 mb-4">₹499</div>
                        <ul className="text-gray-300 text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('ideal_career_paths')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('professional_strengths_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('business_prospects_guidance')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('career_timing_predictions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('skill_development_recommendations')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                    ...
                    <p className="text-gray-400 text-sm mt-3 text-center">
                      {t('comprehensive_career_analysis_note')}
                    </p>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('detailed_career_roadmap')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('professional_strengths_weaknesses')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('business_entrepreneurship_guidance')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('career_transition_timing')}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8">
              ...
              {showThankYou ? (
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-6 mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('detailed_career_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('suitable_career_options')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('professional_development_plan')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('success_timing_analysis')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('entrepreneurship_assessment')}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <>
                  {/* Sample Career Report Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                    <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">💼</span>
                      {t('sample_career_analysis')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-8 border border-purple-500/30">
                        <div className="text-center">
                          ...
                          <h4 className="text-xl font-semibold text-white mb-2">{t('ideal_career_field')}</h4>
                          <p className="text-gray-300 text-sm">{t('sample_career_description')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-4 text-center">
                      {t('sample_career_preview')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs">{t('technology')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl mb-2 text-purple-400">⚕️</div>
                        <div className="text-gray-300 text-xs">{t('healthcare')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl mb-2 text-purple-400">💰</div>
                      ...
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl mb-2 text-purple-400">🎨</div>
                        <div className="text-gray-300 text-xs">{t('creative_arts')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl mb-2 text-purple-400">📚</div>
                        <div className="text-gray-300 text-xs">{t('education')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl mb-2 text-purple-400">🏢</div>
                        <div className="text-gray-300 text-xs">{t('business')}</div>
                      </div>
                    </div>
                  </div>
                </>
