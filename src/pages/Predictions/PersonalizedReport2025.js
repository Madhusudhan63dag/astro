...
const PersonalizedReport2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern - PersonalizedReport2025 symbols */}
      ...
      <div className="relative z-10 py-8 sm:py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            {t('discover_your')} <span className="text-purple-400">{t('personalized_report_2025')}</span>
            <br />
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-start">
            ...
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                  ...
                  {t('enter_details_for_personalized_analysis')}
                </h2>
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('birth_date_comprehensive_analysis')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('exact_time_comprehensive_analysis')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('location_personalized_analysis')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                      <div className="text-center">
                        <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('complete_personalized_analysis_2025')}</h4>
                        <div className="text-3xl sm:text-4xl font-bold text-purple-400 mb-3 sm:mb-4">₹999</div>
                        <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('comprehensive_life_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('year_2025_predictions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('all_life_areas_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('personalized_remedies_solutions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('monthly_guidance_2025')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('premium_pdf_report')}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <p className="text-gray-400 text-xs sm:text-sm mt-3 text-center">
                      {t('comprehensive_personalized_analysis_note')}
                    </p>
                  </div>
                  ...
                  >
                    {isProcessingPayment ? (
                      ...
                      `${t('pay_and_generate_analysis')} - ₹999`
                    )}
                  </button>
                </form>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('complete_life_blueprint')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('year_2025_forecast')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('personalized_remedies')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('monthly_predictions_guide')}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              {showThankYou ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <p className="text-gray-300 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                        {t('personalized_analysis_processing')}
                      </p>
                        ...
                        <div className="bg-black/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                          <div className="text-left text-xs sm:text-sm">
                            ...
                            <p className="text-gray-400">
                              <span className="font-semibold text-white">{t('amount_paid')}:</span> ₹999
                            </p>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="space-y-3 sm:space-y-4 text-left">
                        <div className="flex items-start gap-2 sm:gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-300 text-xs sm:text-sm">{t('within_48_hours_delivery_note')}</p>
                          </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('comprehensive_personalized_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('complete_2025_predictions')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('all_life_areas_detailed_analysis')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('personalized_remedies_guide')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('monthly_action_plan_2025')}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <>
                  {/* Sample Personalized Report 2025 Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">✨</span>
                      {t('sample_personalized_analysis_2025')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-6 sm:p-8 border border-purple-500/30">
                        <div className="text-center">
                          ...
                          <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('year_2025_focus')}</h4>
                          <p className="text-gray-300 text-xs sm:text-sm">{t('sample_2025_reading')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-3 sm:mt-4 text-center text-sm sm:text-base">
                      {t('sample_2025_preview')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs">{t('career_2025')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💕</div>
                        <div className="text-gray-300 text-xs">{t('love_2025')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💰</div>
                        <div className="text-gray-300 text-xs">{t('finance_2025')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💪</div>
                        <div className="text-gray-300 text-xs">{t('health_2025')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">🏠</div>
                        <div className="text-gray-300 text-xs">{t('family_2025')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">🌟</div>
                        <div className="text-gray-300 text-xs">{t('spiritual_2025')}</div>
                      </div>
                    </div>
                  </div>
                </>
                ...
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                    <span className="text-purple-400 mr-3">✨</span>
                    {t('your_personalized_analysis_status')}
                  </h3>
                  <div className="text-center">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3 text-left">
                        <span className="text-purple-400">⏰</span>
                        <span className="text-gray-300 text-sm sm:text-base">{t('delivery_within_48_hours')}</span>
                      </div>
                    </div>
                  </div>
                </div>
...
export default PersonalizedReport2025;
