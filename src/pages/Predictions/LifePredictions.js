...
import birthChartImage from '../../assets/services/life_prediction.webp';
...
const LifePredictions = () => {
  ...
  const BC_PRICE_NUMBER = getRawPrice(PRICE_KEYS.lifePredictions);
  const BC_PRICE_FORMATTED = getFormattedPrice(PRICE_KEYS.lifePredictions);
    ...
    try {
      ...
      if (verifyResult.success) {
        ...
        const astroEmailData = {
          ...
          language: formData.language,
          additionalInfo: 'Complete Life Predictions Analysis Request',
          paymentDetails: {
            status: 'paid',
        ...
        if (emailResult.success) {
          ...
          setAnalysisData({
            ...
            service: 'Life Predictions Analysis',
  ...
  const initializePayment = async (orderData) => {
    ...
    const options = {
      ...
      name: 'SriAstroVeda',
      description: 'Life Predictions Analysis - Complete Kundli Report',
      image: '/logo192.png',
    ...
    try {
      const orderResponse = await fetch(`${API_URL}/create-order`, {
        ...
        body: JSON.stringify({
          amount: BC_PRICE_NUMBER,
          currency: 'INR',
          receipt: `life_predictions_${Date.now()}`,
          notes: {
            service: 'life_predictions_analysis',
    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceFeatures={[
            t('detailed_life_predictions_pdf') || "Detailed Life Predictions (PDF)",
          ...
          <div className="relative z-10 py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
                <span className="text-purple-400">{t('life_predictions')}</span>
                          ...
                          <div className="text-center">
                            ...
                            <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                              <li className="flex items-center gap-2">
                                ...
                                <span>{t('detailed_life_predictions')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
                  ...
                  {!showAnalysis ? (
                    ...
                    <div className="bg-black/60 backdrop-blur-md rounded-2xl p-4 sm:p-6 lg:p-8 border border-purple-700/50">
                      <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                        <span className="text-purple-400 mr-2 sm:mr-3 text-lg sm:text-xl">📊</span>
                        {t('your_life_predictions_status')}
                      </h3>
                      <div className="text-center">
