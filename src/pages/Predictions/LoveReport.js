...
const LoveReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern - LoveReport symbols */}
      ...
      <div className="relative z-10 py-8 sm:py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            {t('discover_your')} <span className="text-purple-400">{t('love_report')}</span>
            <br />
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-start">
              ...
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-4 sm:space-y-6">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('birth_date_love_compatibility')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-gray-400 text-xs sm:text-sm mt-2">
                      {t('exact_time_critical_for_love')}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                      <div className="text-center">
                        ...
                        <div className="text-3xl sm:text-4xl font-bold text-purple-400 mb-3 sm:mb-4">₹449</div>
                        <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('love_compatibility_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('relationship_potential_insights')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('marriage_timing_predictions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('soulmate_identification')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('romantic_guidance_tips')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                    ...
                    <p className="text-gray-400 text-xs sm:text-sm mt-3 text-center">
                      {t('comprehensive_love_analysis_note')}
                    </p>
                  </div>
                  ...
                  >
                    {isProcessingPayment ? (
                      ...
                      `${t('pay_and_generate_analysis')} - ₹449`
                    )}
                  </button>
                </form>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('comprehensive_love_chart')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('romantic_compatibility_score')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('relationship_guidance')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('marriage_timing_insights')}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              {showThankYou ? (
                        ...
                        <div className="bg-black/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                          <div className="text-left text-xs sm:text-sm">
                            ...
                            <p className="text-gray-400">
                              <span className="font-semibold text-white">{t('amount_paid')}:</span> ₹449
                            </p>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('detailed_love_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('compatibility_analysis_detailed')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('relationship_timing_predictions')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('soulmate_characteristics')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('romantic_enhancement_tips')}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <>
                  {/* Sample Love Report Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">💕</span>
                      {t('sample_love_analysis')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-6 sm:p-8 border border-purple-500/30">
                        <div className="text-center">
                          ...
                          <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('love_compatibility_score')}</h4>
                          <p className="text-gray-300 text-xs sm:text-sm">{t('sample_love_reading')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-3 sm:mt-4 text-center text-sm sm:text-base">
                      {t('sample_love_preview')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs">{t('compatibility')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💐</div>
                        <div className="text-gray-300 text-xs">{t('romance')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💍</div>
                      ...
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">👥</div>
                        <div className="text-gray-300 text-xs">{t('soulmate')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">💌</div>
                        <div className="text-gray-300 text-xs">{t('attraction')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">🌹</div>
                        <div className="text-gray-300 text-xs">{t('passion')}</div>
                      </div>
                    </div>
                  </div>
                </>
