...
const NatureReport = () => {
  ...
  const BC_PRICE_NUMBER = getRawPrice(PRICE_KEYS.natureReport);
  const BC_PRICE_FORMATTED = getFormattedPrice(PRICE_KEYS.natureReport);
    ...
    try {
      ...
      if (verifyResult.success) {
        ...
        const astroEmailData = {
          ...
          language: formData.language,
          additionalInfo: 'Complete Nature Analysis Report Request',
          paymentDetails: {
            status: 'paid',
        ...
        if (emailResult.success) {
          ...
          setAnalysisData({
            ...
            service: 'Nature Analysis Report',
  ...
  const initializePayment = async (orderData) => {
    ...
    const options = {
      ...
      name: 'SriAstroVeda',
      description: 'Nature Analysis Report - Complete Kundli Report',
      image: '/logo192.png',
    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceFeatures={[
            t('detailed_nature_report_pdf') || "Detailed Nature Report (PDF)",
          ...
          <div className="relative z-10 py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
                <span className="text-purple-400">{t('nature_report')}</span>
                          ...
                          <div className="text-center">
                            ...
                            <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                              <li className="flex items-center gap-2">
                                ...
                                <span>{t('detailed_nature_report')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
                              ...
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
                                <span>{t('nature_predictions')}</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <span className="text-purple-400 flex-shrink-0">✓</span>
