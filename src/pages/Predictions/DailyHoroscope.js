...
const DailyHoroscope = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      {/* Background Pattern - DailyHoroscope symbols */}
      ...
      <div className="relative z-10 py-8 sm:py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
            {t('discover_your')} <span className="text-purple-400">{t('daily_horoscope')}</span>
            <br />
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-start">
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                      <div className="text-center">
                        <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('daily_horoscope_subscription')}</h4>
                        <div className="text-3xl sm:text-4xl font-bold text-purple-400 mb-3 sm:mb-4">₹99</div>
                        <ul className="text-gray-300 text-xs sm:text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('daily_predictions')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('love_relationship_insights')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('career_money_guidance')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('health_wellness_tips')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('lucky_numbers_colors')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('monthly_horoscope_bonus')}</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <p className="text-gray-400 text-xs sm:text-sm mt-3 text-center">
                      {t('daily_horoscope_subscription_note')}
                    </p>
                  </div>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('personalized_daily_readings')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('love_career_predictions')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('daily_lucky_elements')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300 text-sm sm:text-base">{t('monthly_bonus_insights')}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              {showThankYou ? (
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <p className="text-gray-300 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                        {t('horoscope_subscription_processing')}
                      </p>
                        ...
                        <div className="bg-black/30 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                          <div className="text-left text-xs sm:text-sm">
                            ...
                            <p className="text-gray-400">
                              <span className="font-semibold text-white">{t('amount_paid')}:</span> ₹99
                            </p>
                          </div>
                        </div>
                      )}
                    ...
                    <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border-2 border-blue-400/30 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <div className="space-y-3 sm:space-y-4 text-left">
                        <div className="flex items-start gap-2 sm:gap-3">
                          ...
                          <div>
                            <p className="text-white font-semibold text-sm sm:text-base">{t('daily_delivery')}</p>
                            <p className="text-gray-300 text-xs sm:text-sm">{t('daily_horoscope_delivery_note')}</p>
                          </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('daily_horoscope_reading')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('love_relationship_daily_insights')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('career_financial_guidance')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('health_wellness_daily_tips')}</span>
                        </li>
                        <li className="flex items-center gap-2 sm:gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300 text-xs sm:text-sm">{t('monthly_special_predictions')}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <>
                  {/* Sample Daily Horoscope Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">🌟</span>
                      {t('sample_daily_horoscope')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-6 sm:p-8 border border-purple-500/30">
                        <div className="text-center">
                          ...
                          <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('leo_horoscope_today')}</h4>
                          <p className="text-gray-300 text-xs sm:text-sm">{t('sample_horoscope_reading')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-3 sm:mt-4 text-center text-sm sm:text-base">
                      {t('sample_horoscope_preview')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 sm:gap-4">
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs">{t('aries')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♉</div>
                        <div className="text-gray-300 text-xs">{t('taurus')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♊</div>
                        <div className="text-gray-300 text-xs">{t('gemini')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♋</div>
                        <div className="text-gray-300 text-xs">{t('cancer')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♌</div>
                        <div className="text-gray-300 text-xs">{t('leo')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♍</div>
                        <div className="text-gray-300 text-xs">{t('virgo')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♎</div>
                        <div className="text-gray-300 text-xs">{t('libra')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♏</div>
                        <div className="text-gray-300 text-xs">{t('scorpio')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♐</div>
                        <div className="text-gray-300 text-xs">{t('sagittarius')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♑</div>
                        <div className="text-gray-300 text-xs">{t('capricorn')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♒</div>
                        <div className="text-gray-300 text-xs">{t('aquarius')}</div>
                      </div>
                      <div className="text-center p-3 sm:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-lg sm:text-2xl mb-2 text-purple-400">♓</div>
                        <div className="text-gray-300 text-xs">{t('pisces')}</div>
                      </div>
                    </div>
                  </div>
                </>
                ...
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-purple-700/50">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 flex items-center">
                    <span className="text-purple-400 mr-3">🌟</span>
                    {t('your_horoscope_status')}
                  </h3>
                  <div className="text-center">
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-6 sm:p-8 mb-4 sm:mb-6">
                      <div className="text-4xl sm:text-6xl text-purple-400 mb-3 sm:mb-4">⏳</div>
                      <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">
                        {t('processing_your_subscription')}
                      </h4>
                      <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                        {t('subscription_processing_message')}
                      </p>
                      {analysisData && (
                        <div className="mt-3 sm:mt-4 text-left bg-black/30 rounded-lg p-3 sm:p-4">
                          <p className="text-gray-400 text-xs sm:text-sm mb-1">
                            <span className="font-semibold text-white">{t('subscription_id')}:</span> {analysisData.requestId}
                          </p>
                          <p className="text-gray-400 text-xs sm:text-sm">
                            <span className="font-semibold text-white">{t('status')}:</span> {analysisData.status === 'processing' ? t('processing') : t('active')}
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      <div className="flex items-center gap-2 sm:gap-3 text-left">
                        ...
                        <span className="text-gray-300 text-sm sm:text-base">{t('confirmation_email_sent')}</span>
                      </div>
                      <div className="flex items-center gap-2 sm:gap-3 text-left">
                        <span className="text-blue-400">📱</span>
                        <span className="text-gray-300 text-sm sm:text-base">{t('daily_whatsapp_updates')}</span>
                      </div>
                      <div className="flex items-center gap-2 sm:gap-3 text-left">
                        <span className="text-purple-400">🌅</span>
                        <span className="text-gray-300 text-sm sm:text-base">{t('first_horoscope_tomorrow')}</span>
                      </div>
                    </div>
                  </div>
                </div>
