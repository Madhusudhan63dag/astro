...
//           serviceAmount="₹599"
//           serviceFeatures={[
//             t('detailed_birth_chart_pdf') || "Detailed Birth Chart (PDF)",
...
//                       {/* Date & Time of Birth - Split inputs */}
//                       <div>
...
//                                 className="w-14 sm:w-16 text-center px-3 py-2 rounded-lg bg-gray-900/70 border border-purple-600/40 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
//                               />
...
//                                 onBlur={() => updateDateInForm(dobDay, dobMonth, dobYear)}
//                                 className="w-20 sm:w-24 text-center px-3 py-2 rounded-lg bg-gray-900/70 border border-purple-600/40 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm sm:text-base"
//                               />
//                             </div>
...
//                                 className={`px-3 py-2 text-xs sm:text-sm ${tobMeridiem === 'AM' ? 'bg-purple-600 text-white' : 'bg-gray-900/70 text-gray-200'}`}
//                               >
//                                 {t('am') || 'AM'}
//                               </button>
//                               <button
...
//                                 className={`px-3 py-2 text-xs sm:text-sm ${tobMeridiem === 'PM' ? 'bg-purple-600 text-white' : 'bg-gray-900/70 text-gray-200'}`}
//                               >
//                                 {t('pm') || 'PM'}
//                               </button>
//                             </div>
    ...
    <div>
      {showThankYou ? (
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
          ...
          <div className="relative z-10 py-6 sm:py-12 lg:py-16 px-3 lg:px-8 max-w-7xl mx-auto">
                      ...
                      <div className="bg-gray-800/60 border border-purple-600/40 rounded-xl p-3 sm:p-4">
                        ...
                        <div className="mt-2 sm:mt-3 flex items-center text-xs sm:text-sm">
                          <div className="flex items-center text-gray-400">
                            ...
                            <span>{t('date_time_hint') || 'Enter DD/MM/YYYY and HH:MM (12-hour) with AM/PM'}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                        <div className="text-center">
                          ...
                          <ul className="text-gray-300 text-xs sm:text-sm space-y-1 sm:space-y-2 text-left max-w-sm mx-auto">
                            ...
                            <li className="flex items-center gap-2">
                              <span className="text-purple-400 flex-shrink-0">✓</span>
                              <span>{t('planetary_positions_interpretations') || 'Planetary Positions & Interpretations'}</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <span className="text-purple-400 flex-shrink-0">✓</span>
                              <span>{t('dasha_system_predictions') || 'Dasha System Predictions'}</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <span className="text-purple-400 flex-shrink-0">✓</span>
                              <span>{t('personalized_remedial_suggestions') || 'Personalized Remedial Suggestions'}</span>
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
                {!showAnalysis ? (
                  <>
                    ...
                    {/* Astrological Symbols - Mobile Responsive Grid */}
                    <div className="bg-black/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-purple-700/50">
                      <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 flex items-center">
                        <span className="text-purple-400 mr-2 sm:mr-3 text-lg">🌟</span>
                        {t('astrological_elements')}
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-3 lg:gap-4">
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">☉</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('sun')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">☽</div>
