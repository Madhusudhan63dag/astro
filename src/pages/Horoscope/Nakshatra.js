...
import nakshatraImage from '../../assets/1.webp'; // Update image for nakshatra
...
const Nakshatra = () => {
  ...
  const handleGenerateAnalysis = async (e) => {
    ...
    try {
      ...
      const orderResponse = await fetch(`${API_URL}/create-order`, {
        ...
        body: JSON.stringify({
          amount: 349, // Updated price for nakshatra analysis
          currency: 'INR',
          receipt: `nakshatra_analysis_${Date.now()}`,
          notes: {
            service: 'nakshatra_analysis',
            name: formData.name,
            email: formData.email,
            phone: formData.phone
          }
      ...
      const options = {
        ...
        name: 'SriAstroVeda',
        description: 'Nakshatra Analysis',
        ...
        theme: {
          color: '#0EA5E9' // Sky blue theme for nakshatra
        },
  ...
  const saveToUserHistory = (formData, result) => {
    try {
      ...
      const existingHistory = JSON.parse(localStorage.getItem('nakshatraHistory') || '[]');
      existingHistory.unshift(historyItem);
      
      const limitedHistory = existingHistory.slice(0, 10);
      localStorage.setItem('nakshatraHistory', JSON.stringify(limitedHistory));
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-cyan-900 relative overflow-hidden">
      {/* Background Pattern - Nakshatra symbols */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 text-6xl text-blue-400">⭐</div>
        <div className="absolute top-40 right-20 text-4xl text-cyan-400">🌟</div>
        <div className="absolute bottom-40 left-20 text-5xl text-sky-400">✨</div>
        <div className="absolute bottom-20 right-10 text-3xl text-indigo-400">🌠</div>
        <div className="absolute top-1/2 left-1/4 text-3xl text-blue-300">⭐</div>
        <div className="absolute top-1/3 right-1/3 text-2xl text-cyan-300">🌟</div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-blue-700/50">
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-6">
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('full_name')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="text"
                      name="name"
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-gray-800/80 border border-blue-600/50 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('email_address')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('phone_number')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('gender')} <span className="text-cyan-400">*</span>
                    </label>
                    <select
                      name="gender"
                      value={formData.gender}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-lg bg-gray-800/80 border border-blue-600/50 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
                      required
                    >
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('date_of_birth')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="date"
                      name="dateOfBirth"
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('time_of_birth')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="time"
                      name="timeOfBirth"
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                      {t('exact_time_critical_for_nakshatra')}
                    </p>
                  </div>
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('place_of_birth')} <span className="text-cyan-400">*</span>
                    </label>
                    <input
                      type="text"
                      name="placeOfBirth"
                  ...
                  <div>
                    <label className="block text-gray-100 font-semibold text-lg mb-2">
                      {t('preferred_language')} <span className="text-cyan-400">*</span>
                    </label>
                    <select
                      name="language"
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-blue-400/10 to-cyan-400/10 border-2 border-blue-400/50 rounded-lg p-6">
                      <div className="text-center">
                        <h4 className="text-xl font-semibold text-white mb-2">{t('complete_nakshatra_analysis')}</h4>
                        <div className="text-4xl font-bold text-blue-400 mb-4">₹349</div>
                        <ul className="text-gray-300 text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-blue-400">✓</span>
                            <span>{t('birth_star_identification')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-blue-400">✓</span>
                            <span>{t('personality_traits_detailed')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-blue-400">✓</span>
                            <span>{t('compatibility_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-blue-400">✓</span>
                            <span>{t('career_guidance_nakshatra')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-blue-400">✓</span>
                    ...
                    <p className="text-gray-400 text-sm mt-3 text-center">
                      {t('comprehensive_nakshatra_analysis_note')}
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-bold py-4 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 disabled:scale-100"
                  >
                    {isProcessingPayment ? (
                      ...
                      `${t('pay_and_generate_analysis')} - ₹349`
                    )}
                  </button>
                </form>
                ...
                <div className="mt-8 pt-6 border-t border-blue-700/50">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-blue-400">✓</span>
                      <span className="text-gray-300">{t('your_birth_star_detailed')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-blue-400">✓</span>
                      <span className="text-gray-300">{t('nakshatra_characteristics')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-blue-400">✓</span>
                      <span className="text-gray-300">{t('pada_analysis')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-blue-400">✓</span>
                      <span className="text-gray-300">{t('ruling_deity_insights')}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {showThankYou ? (
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-blue-700/50">
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded-xl p-6 mb-6">
                      <h4 className="text-xl font-semibold text-blue-400 mb-3">
                        {t('payment_successful')}
                      </h4>
                      <p className="text-gray-300 mb-4 leading-relaxed">
                        {t('nakshatra_analysis_processing')}
                      </p>
                        ...
                        <div className="bg-black/30 rounded-lg p-4 mb-4">
                          <div className="text-left text-sm">
                            ...
                            <p className="text-gray-400">
                              <span className="font-semibold text-white">{t('amount_paid')}:</span> ₹349
                            </p>
                          </div>
                        </div>
                      )}
                    ...
                    {/* What You'll Receive */}
                    <div className="bg-gradient-to-r from-blue-400/10 to-cyan-400/10 border-2 border-blue-400/30 rounded-lg p-6 mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-3">
                          <span className="text-blue-400">✓</span>
                          <span className="text-gray-300">{t('detailed_nakshatra_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-blue-400">✓</span>
                          <span className="text-gray-300">{t('birth_star_characteristics')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-blue-400">✓</span>
                          <span className="text-gray-300">{t('pada_and_symbol_analysis')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-blue-400">✓</span>
                          <span className="text-gray-300">{t('compatibility_insights')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-blue-400">✓</span>
                          <span className="text-gray-300">{t('lucky_colors_numbers')}</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row">
                      <a 
                        ...
                        className="px-6 py-3 text-blue-400 border-2 border-blue-400 hover:bg-blue-400 hover:text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 text-center"
                      >
                        {t('contact_support')}
                      </a>
                    </div>
                ...
                <>
                  {/* Sample Nakshatra Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-blue-700/50">
                    <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                      <span className="text-blue-400 mr-3">⭐</span>
                      {t('sample_nakshatra_analysis')}
                    </h3>
                    <div className="relative">
                      <img
                        src={nakshatraImage}
                        alt={t('sample_nakshatra_analysis')}
                        className="w-full rounded-xl shadow-lg"
                      />
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-400/10 to-cyan-400/10 rounded-xl"></div>
                    </div>
                    <p className="text-gray-300 mt-4 text-center">
                      {t('sample_nakshatra_description')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-blue-700/50">
                    <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                      <span className="text-blue-400 mr-3">🌟</span>
                      {t('popular_nakshatras')}
                    </h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">⭐</div>
                        <div className="text-gray-300 text-sm">{t('ashwini')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">🌟</div>
                        <div className="text-gray-300 text-sm">{t('bharani')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">✨</div>
                        <div className="text-gray-300 text-sm">{t('kritika')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">🌠</div>
                        <div className="text-gray-300 text-sm">{t('rohini')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">⭐</div>
                        <div className="text-gray-300 text-sm">{t('mrigashira')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-blue-600/30">
                        <div className="text-2xl mb-2 text-blue-400">🌟</div>
                        <div className="text-gray-300 text-sm">{t('ardra')}</div>
                      </div>
                    </div>
                  </div>
                </>
                ...
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-blue-700/50">
                  <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                    <span className="text-blue-400 mr-3">⭐</span>
                    {t('your_nakshatra_analysis_status')}
                  </h3>
                  <div className="text-center">
                    <div className="bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded-xl p-8 mb-6">
