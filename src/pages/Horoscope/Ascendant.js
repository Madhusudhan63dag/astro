...
const Ascendant = () => {
  ...
  // Centralized pricing for Ascendant service
  const ASC_PRICE_NUMBER = getRawPrice(PRICE_KEYS.ascendant);
  const ASC_PRICE_FORMATTED = getFormattedPrice(PRICE_KEYS.ascendant);
    ...
    <div>
      {showThankYou ? (
        <ThankYouPage 
          ...
          serviceAmount={ASC_PRICE_FORMATTED}
          serviceFeatures={[
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
          <div className="relative z-10 py-6 sm:py-12 px-3 sm:px-4 max-w-7xl mx-auto">
                  ...
                  <form onSubmit={handleGenerateAnalysis} className="space-y-4 sm:space-y-6">
                    ...
                    {formData.timeOfBirth && (
                      <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-400/30 rounded-xl p-4 sm:p-6">
                        <div className="text-center">
                          ...
                          <div className="text-xl sm:text-2xl font-bold text-gray-200 mb-2">
                    ...
                    <div>
                      ...
                      <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-4 sm:p-6">
                        <div className="text-center">
                          <h4 className="text-lg sm:text-xl font-semibold text-white mb-2">{t('complete_ascendant_analysis')}</h4>
                          <div className="text-3xl sm:text-4xl font-bold text-purple-400 mb-3 sm:mb-4">{ASC_PRICE_FORMATTED}</div>
                    ...
                    >
                      {isProcessingPayment ? (
                        ...
                        <span className="text-xs sm:text-base">{`${t('pay_and_generate_analysis')} - ${ASC_PRICE_FORMATTED}`}</span>
                      )}
                    </button>
                  </form>
                </div>
              ...
              <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
                {!showAnalysis ? (
                  <>
                    ...
                    {/* Rising Signs - Mobile Responsive Grid */}
                    <div className="bg-black/60 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-purple-700/50">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-3 lg:gap-4">
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          ...
                          <div className="text-gray-300 text-xs sm:text-sm">{t('aries_rising')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">♉</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('taurus_rising')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">♊</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('gemini_rising')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">♋</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('cancer_rising')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">♌</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('leo_rising')}</div>
                        </div>
                        <div className="text-center p-2 sm:p-3 lg:p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                          <div className="text-lg sm:text-xl lg:text-2xl mb-1 sm:mb-2 text-purple-400">♍</div>
                          <div className="text-gray-300 text-xs sm:text-sm">{t('virgo_rising')}</div>
                        </div>
                      </div>
                    </div>
                  </>
