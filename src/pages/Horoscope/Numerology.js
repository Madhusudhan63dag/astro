...
const Numerology = () => {
  ...
  return (
      ...
      {/* Background Pattern - Numerology symbols */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 text-6xl text-purple-400">🔢</div>
        <div className="absolute top-40 right-20 text-4xl text-pink-400">✨</div>
        <div className="absolute bottom-40 left-20 text-5xl text-violet-400">🔢</div>
        <div className="absolute bottom-20 right-10 text-3xl text-indigo-400">✨</div>
        <div className="absolute top-1/2 left-1/4 text-3xl text-purple-300">🔢</div>
        <div className="absolute top-1/3 right-1/3 text-2xl text-pink-300">✨</div>
      </div>
            ...
            <div className="space-y-8">
              <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                  ...
                  {t('enter_details_for_numerology')}
                </h2>
                ...
                <form onSubmit={handleGenerateAnalysis} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/50 rounded-lg p-6">
                      <div className="text-center">
                        <h4 className="text-xl font-semibold text-white mb-2">{t('complete_numerology_analysis')}</h4>
                        <div className="text-4xl font-bold text-purple-400 mb-4">₹299</div>
                        <ul className="text-gray-300 text-sm space-y-2 text-left max-w-sm mx-auto">
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('life_path_number_analysis')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('destiny_number_insights')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('personality_number_traits')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('lucky_numbers_and_colors')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                            <span>{t('career_compatibility_numbers')}</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <span className="text-purple-400">✓</span>
                    ...
                    <p className="text-gray-400 text-sm mt-3 text-center">
                      {t('comprehensive_numerology_analysis_note')}
                    </p>
                  </div>
                  ...
                  >
                    {isProcessingPayment ? (
                      ...
                      `${t('pay_and_generate_analysis')} - ₹299`
                    )}
                  </button>
                </form>
                ...
                <div className="mt-8 pt-6 border-t border-purple-700/50">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('complete_numerology_chart')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('core_numbers_analysis')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
                      <span className="text-gray-300">{t('personal_year_predictions')}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-purple-400">✓</span>
              ...
              {showThankYou ? (
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                  <div className="text-center">
                    ...
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-6 mb-6">
                      <h4 className="text-xl font-semibold text-purple-400 mb-3">
                        {t('payment_successful')}
                      </h4>
                      <p className="text-gray-300 mb-4 leading-relaxed">
                        {t('numerology_analysis_processing')}
                      </p>
                        ...
                        <div className="bg-black/30 rounded-lg p-4 mb-4">
                          <div className="text-left text-sm">
                            ...
                            <p className="text-gray-400">
                              <span className="font-semibold text-white">{t('amount_paid')}:</span> ₹299
                            </p>
                          </div>
                        </div>
                      )}
                    ...
                    {/* What You'll Receive */}
                    <div className="bg-gradient-to-r from-purple-400/10 to-pink-400/10 border-2 border-purple-400/30 rounded-lg p-6 mb-6">
                      ...
                      <ul className="text-left space-y-2">
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('detailed_numerology_report_pdf')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('life_path_destiny_analysis')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('personal_numbers_meanings')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('lucky_elements_guidance')}</span>
                        </li>
                        <li className="flex items-center gap-3">
                          <span className="text-purple-400">✓</span>
                          <span className="text-gray-300">{t('annual_forecast_insights')}</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row">
                      <a 
                        ...
                        className="px-6 py-3 text-purple-400 border-2 border-purple-400 hover:bg-purple-400 hover:text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 text-center"
                      >
                        {t('contact_support')}
                      </a>
                    </div>
                ...
                <>
                  {/* Sample Numerology Display */}
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                    <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                      <span className="text-purple-400 mr-3">🔢</span>
                      {t('sample_numerology_analysis')}
                    </h3>
                    <div className="relative">
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-xl p-8 border border-purple-500/30">
                        <div className="text-center">
                          <div className="text-6xl text-purple-400 mb-4">7</div>
                          <h4 className="text-xl font-semibold text-white mb-2">{t('life_path_number')}</h4>
                          <p className="text-gray-300 text-sm">{t('sample_life_path_description')}</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-gray-300 mt-4 text-center">
                      {t('sample_numerology_description')}
                    </p>
                  </div>
                  ...
                  <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        ...
                        <div className="text-gray-300 text-xs">{t('life_path')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl font-bold mb-2 text-purple-400">5</div>
                        <div className="text-gray-300 text-xs">{t('destiny')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl font-bold mb-2 text-purple-400">3</div>
                        <div className="text-gray-300 text-xs">{t('personality')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl font-bold mb-2 text-purple-400">9</div>
                        <div className="text-gray-300 text-xs">{t('soul_urge')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl font-bold mb-2 text-purple-400">7</div>
                        <div className="text-gray-300 text-xs">{t('birthday')}</div>
                      </div>
                      <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-purple-600/30">
                        <div className="text-2xl font-bold mb-2 text-purple-400">2</div>
                        <div className="text-gray-300 text-xs">{t('maturity')}</div>
                      </div>
                    </div>
                  </div>
                </>
                ...
                <div className="bg-black/60 backdrop-blur-md rounded-2xl p-8 border border-purple-700/50">
                  <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                    <span className="text-purple-400 mr-3">🔢</span>
                    {t('your_numerology_analysis_status')}
                  </h3>
                  <div className="text-center">
                    <div className="bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-xl p-8 mb-6">
